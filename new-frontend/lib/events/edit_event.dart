  ...
  void _updateEvent() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        showSnackbar(context, FeedbackLevel.error, "Error updating event", null);
        return;
      }
    ...
    return QuickAlert.show(
      ...
      onConfirmBtnTap: () {
        try {
          ...
          showSnackbar(context, FeedbackLevel.error, "Error deleting event", null);
          return;
        }
        showSnackbar(context, FeedbackLevel.success, "Event deleted successfully", null);
        Navigator.of(context).pop();
        Navigator.of(context).pop();
      },
    );
