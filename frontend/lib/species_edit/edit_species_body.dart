...
class EditSpeciesBody extends StatefulWidget {
  final SpeciesDTO species;

  const EditSpeciesBody({
    super.key,
    required this.species,
  });

  @override
  State<EditSpeciesBody> createState() => _EditSpeciesBodyState();
}

class _EditSpeciesBodyState extends State<EditSpeciesBody> {
  @override
