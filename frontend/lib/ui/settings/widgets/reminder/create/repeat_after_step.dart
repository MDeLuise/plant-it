...
class RepeatAfterStep extends StepSection<AddReminderViewModel> {
  ...
  late final ValueNotifier<FrequencyUnit> _selectedFrequencyUnit =
      ValueNotifier(FrequencyUnit.days);
  late final ValueNotifier<int> _selectedFrequencyQuantity = ValueNotifier(3);
  late final ValueNotifier<FrequencyUnit> _ongoingFrequencyUnit =
      ValueNotifier(FrequencyUnit.days);
  late final ValueNotifier<int> _ongoingFrequencyQuantity = ValueNotifier(3);
