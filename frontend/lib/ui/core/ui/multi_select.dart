...
class TextFieldMultipleDropDown<T> extends StatefulWidget {
  ...
  @override
  State<TextFieldMultipleDropDown<T>> createState() =>
      _TextFieldMultipleDropDownState<T>();
}

class _TextFieldMultipleDropDownState<T>
    extends State<TextFieldMultipleDropDown<T>> {
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        if (isSelected)
                          const Icon(Icons.check_box_outlined, weight: 1)
                        else
                          const Icon(Icons.check_box_outline_blank, weight: 1),
          ...
          return widget.options.map(
            (item) {
              return Container(
                ...
                child: Text(
                  _selectedItems.map(widget.getLabel).join(', '),
                  style: TextStyle(
