...
class AvatarStep extends StepSection<EditSpeciesViewModel> {
  ...
  AvatarStep({
    ...
    db.Image? image = viewModel.image;
    if (image == null) {
      return;
    }
    if (image.imageUrl != null) {
      _avatarOption.value = 1;
      _selectedAvatarUrl.value = image.imageUrl;
      _ongoingAvatarUrl.value = image.imageUrl;
    }
    if (image.imagePath != null) {
      _avatarOption.value = 2;
      XFile dummy = XFile(image.imagePath!);
      _selectedAvatarImage.value = dummy;
      _ongoingAvatarImage.value = dummy;
    }
  }
