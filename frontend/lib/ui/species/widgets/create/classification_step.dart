...
class ClassificationStep extends StepSection<AddSpeciesViewModel> {
  final ValueNotifier<bool> _isValidNotifier = ValueNotifier(false);
  final ValueNotifier<String?> _selectedSpecies = ValueNotifier(null);
  final ValueNotifier<String?> _ongoingSpeciesSelection = ValueNotifier(null);
  final ValueNotifier<String?> _selectedFamily = ValueNotifier(null);
  final ValueNotifier<String?> _ongoingFamilySelection = ValueNotifier(null);
  final ValueNotifier<String?> _selectedGenus = ValueNotifier(null);
  final ValueNotifier<String?> _ongoingGenusSelection = ValueNotifier(null);
  final ValueNotifier<List<String>> _selectedSynonyms =
      ValueNotifier(List.unmodifiable([]));
  final ValueNotifier<List<String>> _ongoingSynonymsSelection =
      ValueNotifier(List.unmodifiable([]));
        ...
        return AlertDialog(
          ...
          content: TextField(
            ...
            decoration: InputDecoration(
              labelText: L.of(context).species,
            ...
            builder: (BuildContext context, StateSetter setState) {
              return Column(
                ...
                children: [
                            ...
                            children: [
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: L.of(context).synonym,
                                    border: OutlineInputBorder(),
                                  ),
                                  maxLines: null,
                                  autofocus: true,
                  ...
                  TextButton(
                    child: Text(L.of(context).addSynonym),
                    onPressed: () {
                      controllers.add(TextEditingController());
                      setState(() {});
                    },
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(L.of(context).classification,
